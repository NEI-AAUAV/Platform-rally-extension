...
class RallyDurationCalculator:
    ...
    def _build_base_status(self, current_time: datetime) -> dict[str, Any]:
        return {
            ...
            "rally_start_time": self.settings.rally_start_time.isoformat()
            if self.settings.rally_start_time
            else None,
            "rally_end_time": self.settings.rally_end_time.isoformat()
    ...
    def _extract_datetime(self, value: object) -> datetime | None:
        """
    ...
    def _build_not_started_status(
        self, status: dict[str, Any], start_time: datetime, current_time: datetime
    ) -> dict[str, Any]:
    ...
    def get_team_rally_duration(self, team_start_time: datetime) -> dict[str, Any]:
        ...
        total_rally_duration: timedelta | None = None
        end_time: datetime | None = self.settings.rally_end_time  # type: ignore[assignment]
        start_time: datetime | None = self.settings.rally_start_time  # type: ignore[assignment]
        ...
        return {
            ...
            "total_rally_duration": self._format_duration(total_rally_duration)
            if total_rally_duration
            else None,
            "total_rally_duration_seconds": total_rally_duration.total_seconds()
            if total_rally_duration
            else None,
