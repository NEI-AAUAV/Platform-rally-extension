...
class TestStaffRegistrationGate:
    ...
    async def test_staff_blocked_when_registration_disabled(self, pg_session, pg_client, as_staff):
        ...
        as_staff.staff_checkpoint_id = 1
        await _make_event(pg_session)
    ...
    async def test_staff_allowed_when_registration_enabled(self, pg_session, pg_client, as_staff):
        as_staff.staff_checkpoint_id = 1
        await _make_event(pg_session)
