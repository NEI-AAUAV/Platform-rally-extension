...
class GeneralActivity(BaseActivity):
    ...
    def persisted_score_fields(self, result_data: dict[str, Any]) -> dict[str, Any]:
        return {"points_score": result_data.get("assigned_points")}

    @classmethod
    def get_default_config(cls) -> dict[str, Any]:
        return {"min_points": 0, "max_points": 100, "default_points": 50}
    ...
    def get_result_schema(self) -> dict[str, Any]:
        ...
        return {
            "type": "object",
            "properties": {
                "assigned_points": {"type": "number", "minimum": min_points, "maximum": max_points},
