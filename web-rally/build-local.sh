...
echo ""
echo "📦 To upload as artifact or deploy:"
echo "   - Upload: tar -czf rally-web.tar.gz -C dist ."
echo "   - Deploy: rsync -a --delete dist/ user@server:/var/www/rally/"
echo "   - Docker: Use Dockerfile.prod (multi-stage with nginx)"
