...
export const ADMIN_SEARCH_INDEX: readonly AdminSearchEntry[] = [
  // ---- Settings: Equipas ----
  { key: "max_teams", label: "Número máximo de equipas", tabId: "settings", settingsSectionId: "equipas" },
  { key: "max_members_per_team", label: "Máximo de membros por equipa", tabId: "settings", settingsSectionId: "equipas" },
  { key: "enable_versus", label: "Ativar modo versus", tabId: "settings", settingsSectionId: "equipas" },
  { key: "allow_staff_registration", label: "Inscrições no local pelo staff", tabId: "settings", settingsSectionId: "equipas" },

  // ---- Settings: Pontuação ----
  { key: "enable_staff_scoring", label: "Permitir pontuação manual pelos staff", tabId: "settings", settingsSectionId: "pontuacao" },
  { key: "penalty_per_puke", label: "Penalização por vómito", tabId: "settings", settingsSectionId: "pontuacao" },
  { key: "penalty_per_not_drinking", label: "Penalização por não beber", tabId: "settings", settingsSectionId: "pontuacao" },
  { key: "bonus_per_extra_shot", label: "Bónus por shot extra", tabId: "settings", settingsSectionId: "pontuacao" },
  { key: "max_extra_shots_per_member", label: "Máximo shots extra por membro", tabId: "settings", settingsSectionId: "pontuacao" },

  // ---- Settings: Jogo ----
  { key: "reveal_next_checkpoint", label: "Revelar o próximo posto antes da chegada", tabId: "settings", settingsSectionId: "jogo" },
  { key: "reveal_on_arrival", label: "Revelar o posto ao chegar", tabId: "settings", settingsSectionId: "jogo" },
  { key: "participant_view_enabled", label: "Ativar visualização para participantes", tabId: "settings", settingsSectionId: "jogo" },
  { key: "gps_checkin_enabled", label: "Check-in por GPS feito pela equipa", tabId: "settings", settingsSectionId: "jogo" },
  { key: "guide_manual_arrival_enabled", label: "Guias podem marcar chegadas", tabId: "settings", settingsSectionId: "jogo" },
  { key: "hints_enabled", label: "Permitir pedir pistas", tabId: "settings", settingsSectionId: "jogo" },
  { key: "hint_penalty", label: "Custo de uma pista", tabId: "settings", settingsSectionId: "jogo", requiresField: { name: "hints_enabled", value: true } },
  { key: "skip_enabled", label: "Permitir desistir de um posto", tabId: "settings", settingsSectionId: "jogo" },
  { key: "skip_penalty", label: "Custo de desistir de um posto", tabId: "settings", settingsSectionId: "jogo", requiresField: { name: "skip_enabled", value: true } },

  // ---- Settings: Rota ----
  { key: "checkpoint_order_matters", label: "A ordem dos postos importa", tabId: "settings", settingsSectionId: "rota" },
  { key: "route_stages_enabled", label: "Etapas da rota", tabId: "settings", settingsSectionId: "rota" },
  { key: "checkpoint_hours_enabled", label: "Respeitar horários dos postos", tabId: "settings", settingsSectionId: "rota" },
  { key: "leg_time_scoring_enabled", label: "Pontuar tempo de percurso entre postos", tabId: "settings", settingsSectionId: "rota" },
  { key: "leg_time_target_minutes", label: "Tempo esperado entre postos", tabId: "settings", settingsSectionId: "rota", requiresField: { name: "leg_time_scoring_enabled", value: true } },
  { key: "leg_time_points_per_minute", label: "Pontos por minuto de desvio", tabId: "settings", settingsSectionId: "rota", requiresField: { name: "leg_time_scoring_enabled", value: true } },
  { key: "leg_time_max_adjustment", label: "Limite do ajuste por percurso", tabId: "settings", settingsSectionId: "rota", requiresField: { name: "leg_time_scoring_enabled", value: true } },
  { key: "proximity_enabled", label: "Botão estou perto", tabId: "settings", settingsSectionId: "rota" },
  { key: "compass_enabled", label: "Bússola", tabId: "settings", settingsSectionId: "rota" },
  { key: "search_radius_m", label: "Raio da zona de busca", tabId: "settings", settingsSectionId: "rota" },

  // ---- Settings: Visualização ----
  { key: "show_score_mode", label: "Modo de Visualização da Pontuação", tabId: "settings", settingsSectionId: "visualizacao" },
  { key: "show_live_leaderboard", label: "Mostrar leaderboard em tempo real", tabId: "settings", settingsSectionId: "visualizacao" },
  { key: "show_team_details", label: "Mostrar detalhes das equipas", tabId: "settings", settingsSectionId: "visualizacao" },
  { key: "show_route_mode", label: "Modo de Visualização do Trajeto", tabId: "settings", settingsSectionId: "visualizacao" },
  { key: "show_checkpoint_map", label: "Mostrar mapa dos checkpoints", tabId: "settings", settingsSectionId: "visualizacao" },
  { key: "public_access_enabled", label: "Permitir acesso público", tabId: "settings", settingsSectionId: "visualizacao" },
  { key: "guide_mode_enabled", label: "Ativar funcionalidade de modo guia", tabId: "settings", settingsSectionId: "visualizacao" },
  { key: "guide_mode_active", label: "Modo guia ativo neste evento", tabId: "settings", settingsSectionId: "visualizacao" },
  { key: "badges_enabled", label: "Ativar crachás/conquistas", tabId: "settings", settingsSectionId: "visualizacao" },
  { key: "allow_photo_as_team_photo", label: "Permitir staff definir foto de atividade como foto da equipa", tabId: "settings", settingsSectionId: "visualizacao" },

  // ---- Settings: Início ----
  { key: "home_layout", label: "Secções da página inicial", tabId: "settings", settingsSectionId: "inicio" },
  { key: "ticker_items_list", label: "Faixa de destaques", tabId: "settings", settingsSectionId: "inicio" },

  // ---- Settings: Regras ----
  { key: "rules_sections", label: "Secções de regras", tabId: "settings", settingsSectionId: "regras" },
