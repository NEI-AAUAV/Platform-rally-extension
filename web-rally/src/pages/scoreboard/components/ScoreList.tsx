...
function reachedOf(team: ListingTeam): number {
  return team.resolved_checkpoint_orders?.length ?? 0;
}
          ...
          return (
            ...
            >
              ...
              >
                ...
                <span className="rally-bg-accent-soft grid h-10 w-10 shrink-0 place-items-center overflow-hidden rounded-full text-sm font-bold text-foreground">
                  {team.photo_url ? (
                    <img
                      src={team.photo_url}
                      alt={team.name}
