                        ...
                        <Card className="border-0 bg-transparent shadow-none p-0">
                            ...
                            <div className="space-y-4">
                                ...
                                {nextCheckpoint.latitude && nextCheckpoint.longitude && (
                                    <a
                                        href={`https://www.google.com/maps/search/?api=1&query=${nextCheckpoint.latitude},${nextCheckpoint.longitude}`}
                                        target="_blank"
                                        ...
                                        {isExpanded && (
                                            <div className="px-4 pb-4 pt-0 pl-14 opacity-80 space-y-2 animate-in slide-in-from-top-2">
                                                ...
                                                {checkpoint?.latitude && checkpoint?.longitude && (
                                                    <a
                                                        href={`https://www.google.com/maps/search/?api=1&query=${checkpoint.latitude},${checkpoint.longitude}`}
                                                        target="_blank"
                                                        rel="noopener noreferrer"
