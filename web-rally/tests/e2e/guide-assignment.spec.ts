...
async function mockSettings(page: Page) {
  await page.route("**/api/rally/v1/rally/settings/public**", (route) =>
    route.fulfill({
      ...
      body: JSON.stringify({ ...MOCK_RALLY_SETTINGS, guide_mode_enabled: true }),
    }),
  );
}

const TEAMS = [
  { id: 3, name: "Equipa 3", total: 0, num_members: 0, classification: -1, photo_url: "" },
];
