...
import RotationScheduleView from "@/pages/admin/components/events/RotationScheduleView";
...
describe("RotationScheduleView", () => {
  ...
  it("renders a single round with a single pair using fallback names before load", () => {
    renderWithClient(<RotationScheduleView rounds={[[{ team_id: 1, checkpoint_id: 2 }]]} />);
