...
describe("LinkMemberPanel", () => {
  ...
  it("renders the search form", () => {
    render(<LinkMemberPanel teamId={1} placeholderUserId={2} onLinked={onLinked} />, {
  ...
  it("shows an error message when search fails", async () => {
    vi.mocked(TeamMemberLinkService.searchOidcUsers).mockRejectedValue(new Error("search failed"));
