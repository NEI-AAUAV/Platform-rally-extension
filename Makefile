.PHONY: help dev dev-backend dev-db dev-down dev-build dev-logs dev-restart dev-clean dev-ps web-dev web-build prod prod-pull prod-build prod-down prod-logs test test-backend test-web lock
